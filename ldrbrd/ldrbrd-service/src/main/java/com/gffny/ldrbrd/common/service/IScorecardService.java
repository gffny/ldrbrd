...
public interface IScorecardService {
	...
	public Scorecard startCompetitionScorecard(String golfer,
			...
			List<CommonIDEntity> clubList) throws AuthorisationException,
			ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public Scorecard startCompetitionScorecardWithGolferScorerAndCompetitionRoundId(String golfer,
			String scoreKeeperId, String competitionRoundId,
			List<CommonIDEntity> clubList) throws AuthorisationException,
			ServiceException;
	...
	public void scoreHole(int scorecardId, int holeNumber, int holeScore,
			String holeId) throws AuthorisationException, ServiceException;
	 ...
	 */
	// public void scoreShotMap(String scorecardId, Map<Integer, HoleShot>
	// scorecardScoreShotMap);
	...
	/**
	 * returns if the golfer (with golferId) has a scorecard that is currently
	 * active
	 * 
	 * @param golferId
	 * @return
