...
import com.gffny.ldrbrd.common.model.impl.ScoringFormat;
...
public class CompetitionRoundDaoTest {
	...
	public void setUp() throws Exception {
		...
		ScoringFormat stableford = new ScoringFormat("Stableford",
				"com.gffny.ldrbrd.common.scoring.impl.Stableford");
		stableford.setId(1);
		testCompetitionRound.setScoringFormat(stableford);
